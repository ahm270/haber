...
<?php
	...
	$sql = mysql_query("select 
			...
			on h.TC_NO = k.TC_NO where h.TURU_ID != 1 and h.TURU_ID != 2 and h.TURU_ID != 3 ");
		...
		<div class="col-sm-4">
			...
			<img class="card-img-top" src="urun/2.jpg" alt="Card image cap">
		  <div class="card-body">
	...
	echo'</div>';?>
		...
		$sql = mysql_query("insert into yorum (YORUM, HABER_ID, TC_NO)
		  ...
		  echo '<meta http-equiv="refresh" content="0; URL=adiger.php?kullaniciadi='.$kuladi.'" />';}
							?>
							<?php
	if (isset($_GET["sil"])){
		$sil = $_GET["sil"];
