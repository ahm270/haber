			...
			echo '<nav class="navbar navbar-expand-lg navbar-light" style="background-color:aqua;">
				...
				from turu ");	
					while($dizi= mysql_fetch_array($sql2))
						{
								echo '<a class="dropdown-item" href="gtur.php?ogrencino='.$ogn.'&turad='.$dizi["TURU_ID"].'">'.$dizi["TURU_ADI"].'</a>';
								}
							echo'
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="oghaperler.php?ogrencino='.$ogn.'"">haperler düzeltme</a>
						</li>
						<li class="nav-item">
